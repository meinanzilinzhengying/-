<template>
  ...
  <div class="resource-analysis-content">
    ...
    <div class="resource-header">
      ...
      <div class="time-range-selector">
        ...
        <el-form :inline="true" :model="resourceForm" class="demo-form-inline">
          ...
          <el-form-item label="网络流量监控">

            <el-select v-model="resourceForm.dataSource" placeholder="选择数据源" style="width: 150px;">

              <el-option label="网络数据源" value="network" />

              <el-option label="系统数据源" value="system" />
          ...
          <el-form-item label="搜索快照管理">
            ...
            <el-select v-model="resourceForm.timeRange" placeholder="搜索关键词" style="width: 120px;">
          ...
          <el-form-item>
            ...
            <el-input v-model="resourceForm.search" placeholder="搜索关键词" style="width: 200px;" />
    ...
    <div class="metrics-selector">
      ...
      <el-form :inline="true" :model="metricsForm" class="demo-form-inline">
        ...
        <el-form-item label="指标选择">
          ...
          <el-select v-model="metricsForm.primaryMetric" placeholder="选择默认流量" style="width: 120px;">
        ...
        <el-form-item label="分组依据">
          ...
          <el-select v-model="metricsForm.groupBy" placeholder="auto_service" style="width: 120px;">
            ...
            <div class="chart-content">
              ...
              <div class="mock-chart">
                ...
                <div class="chart-bars">
                  ...
                  <div v-for="i in 30" :key="i" class="chart-bar throughput-bar" :style="{ height: throughputData[i-1] + '%' }"></div>
            ...
            <div class="chart-content">
              ...
              <div class="mock-chart">
                ...
                <div class="chart-bars">
                  ...
                  <div v-for="i in 30" :key="i" class="chart-bar retransmit-bar" :style="{ height: retransmitData[i-1] + '%' }"></div>
            ...
            <div class="chart-content">
              ...
              <div class="mock-chart">
                ...
                <div class="chart-bars">
                  ...
                  <div v-for="i in 30" :key="i" class="chart-bar connect-bar" :style="{ height: connectData[i-1] + '%' }"></div>
...
const resourceTotal = ref(100);



// 模拟流量详情

const throughputData = [50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50]

const retransmitData = [25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25]

const connectData = [50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50]



const resources = Array(10).fill(0).map((_, index) => ({
